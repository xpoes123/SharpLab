"""Multiplayer /geography speed race.

Given a country, first to type its capital wins the round.
First to WINS_TO_WIN round wins.
"""
...
class GeoTableView(ui.View):
    ...
    async def _end_game(self) -> None:
        ...
        if len(table.players) >= 2:
            ...
            try:
                await update_elo_multiplayer(finish_order, "geography", "geography")
            except Exception:
                pass
